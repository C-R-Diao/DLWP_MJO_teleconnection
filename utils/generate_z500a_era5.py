def generate_z500a_era5():
    ...
    for date in dates:
        print(date)
        fpath_exp = f'../ERA5/validation_hist-MJO-P3/'
        fout_name = f'era5_z500a_{date}_day0-30.nc'
        fin_name = f'era5_Z_{date}_30days.nc'
...
#===================================================================================================
def create_z500a_casemean_era5():
    '''
    ...
    fout_name = f'era5_z500a_case-mean.day0-30.nc'
